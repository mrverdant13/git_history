...
class _$RepositoryTearOff {
  ...
  _Repository call({required int id, required String name}) {
    return _Repository(
      id: id,
      name: name,
    );
...
class _$_Repository implements _Repository {
  const _$_Repository({required this.id, required this.name});
...
abstract class _Repository implements Repository {
  const factory _Repository({required int id, required String name}) =
      _$_Repository;
